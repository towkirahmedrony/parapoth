...
import Selection from '../../features/exam/pages/Selection'; // এক্সাম ট্যাব সরাসরি ইম্পোর্ট করা হলো
...
const EditProfile = lazy(() => import('../../features/profile/pages/EditProfile')); // Added Edit Profile
  ...
  return (
    <Suspense fallback={<div className="min-h-screen bg-slate-50 dark:bg-slate-900"></div>}>
      <Routes>
        ...
        <Route path="/edit-profile" element={<PermissionGuard><EditProfile /></PermissionGuard>} /> {/* Added Edit Profile Route */}
