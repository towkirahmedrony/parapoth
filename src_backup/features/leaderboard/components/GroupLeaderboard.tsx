  ...
  if (isLoading || !data) {
    return (
      ...
      >
        ...
        ></div>
        <div style={{ color: mutedTextColor }}>Loading Leaderboard...</div>
      </div>
    );
  }

  // Safely using strongly typed fields (normalized from useSquadLeaderboard)
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <span className="text-xs mt-1 block" style={{ color: mutedTextColor }}>
              Compete with squads across ParaPoth
            </span>
          </div>
        </div>
        <button 
