...
export const LiveExamMonitor: React.FC<Props> = ({ examId }) => {
  ...
  // Memoized count to prevent unnecessary recalculations
  const activeUsersCount = useMemo(() => progressList?.length || 0, [progressList]);
