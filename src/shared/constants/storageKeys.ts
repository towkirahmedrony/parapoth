export const STORAGE_KEYS = {
  ...
  DYN_THEME: 'dyn_theme', // Added for SystemGuard Dynamic Theme
  DISMISSED_NOTICE: 'dismissed_global_notice', // Added for SystemGuard Global Notice
...
export const QUERY_KEYS = {
  ...
  SYSTEM_CONFIGS: ['system-configs'] as const, // Added for SystemGuard
} as const;
